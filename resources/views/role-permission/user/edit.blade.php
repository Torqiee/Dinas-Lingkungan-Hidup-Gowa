                    ...
                    <div class="d-flex justify-content-between">
                     <button class="btn px-1 open-btn me-2"><i class="fa-solid fa-bars-staggered"></i></button>
                        <a class="navbar-brand fs-4" href="#">
                            <span class="px-2 fw-semibold">Edit Data Pengguna Admin</span>
                        </a>
                    </div>
                ...
                <div class="container p-3 rounded-4" style="background-color: #eee">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{ url('users/'.$user->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <label for="input1" class="form-label">Nama Pengguna</label>
                                <input type="text" name="name" value="{{ $user->name }}" class="form-control border-3 border-success focus-ring focus-ring-success" id="input1">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" readonly value="{{ $user->email }}" class="form-control border-3 border-success focus-ring focus-ring-success" id="input2" placeholder="example: hello@gmail.com">
                            </div>
                            <div class="col-md-6">
                                <label for="input3" class="form-label">Roles</label>
                                <select name="roles[]" id="input3" class="form-control border-3 border-success focus-ring focus-ring-success" multiple>
                                    <option value="" id="input3">Select Role</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="password" class="form-control border-3 border-success focus-ring focus-ring-success" id="input2">
                                @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mt-3 mb-1">
                                <button type="submit" class="btn rounded-3 btn-success fw-semibold px-4 py-2">Update data</button>
                            </div>
                        </form>
                    </div>
                </div>
