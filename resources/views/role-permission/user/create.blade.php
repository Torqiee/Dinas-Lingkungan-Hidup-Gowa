        ...
        <div class="content">
            ...
            <div class="dashboard-content px-3 pt-3">
                <div class="container p-3 rounded-4" style="background-color: #eee">
                    <div class="d-flex">
                        <a href="{{ url('users') }}" type="button" class="btn rounded-3 pe-4 ps-4 fw-semibold" style="background-color: #315A39; color: #F5F5F5;"><i class="fa-solid fa-arrow-left me-2"></i>Kembali</a>
                    </div>
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{ url('users') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control border-3 border-success focus-ring focus-ring-success" id="input2" placeholder="example: hello@gmail.com">
                            </div>
                            <div class="col-md-6">
