                    ...
                    <div class="d-flex justify-content-between">
                     <button class="btn px-1 open-btn me-2"><i class="fa-solid fa-bars-staggered"></i></button>
                        <a class="navbar-brand fs-4" href="#">
                            <span class="px-2 fw-semibold">Data Role Admin</span>
                        </a>
                    </div>
            ...
            <div class="dashboard-content px-3 pt-3">
                <div class="container p-3 rounded-4" style="background-color: #eee">
                    ...
                    <div class="d-flex align-items-center">
                        <h4 class="pt-2">Role {{ $role->name }}</h4>
                        <a href="{{ url('users') }}" type="button" class="btn rounded-3 px-4 ms-auto fw-semibold" style="background-color: #315A39; color: #F5F5F5;"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
                    </div>
