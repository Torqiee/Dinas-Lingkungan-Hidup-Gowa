        ...
        <div class="content">
            ...
            <div class="dashboard-content px-3 pt-3">
                <div class="container p-3 rounded-4" style="background-color: #eee">
                    <div class="d-flex">
                        <a href="{{ url('roles') }}" type="button" class="btn rounded-3 px-4 fw-semibold" style="background-color: #315A39; color: #F5F5F5;"><i class="fa-solid fa-arrow-left me-2"></i>Kembali</a>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ url('roles/'.$role->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="role" name="name" value="{{ $role->name }}" class="form-control border-3 border-success focus-ring focus-ring-success" />
                            </div>
                            <div class="mt-3 mb-1">
