            ...
            <div class="dashboard-content px-3 pt-3">
                <div class="container p-3 rounded-4 mb-3" style="background-color: #eee">
                    ...
                    <div class="d-flex align-items-center">
                        <h4 class="fw-semibold me-3 pt-2">Edit Program Kerja Dinas</h4>
                    ...
                    <div class="card-body">
                        <form class="row g-2" action="{{ url('edit-proker/create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <label for="input1" class="form-label">Upload Image Program Kerja</label>
                                <input type="file" name="image_prog" class="form-control border-3 border-success focus-ring focus-ring-success" id="input1">
                            </div>
                            <div class="col-md-6">
                                <label for="input2" class="form-label">Nama Judul Program Kerja</label>
                                <input type="text" name="judul_prog" class="form-control border-3 border-success focus-ring focus-ring-success" id="input2">
                            </div>
                            <div class="col-md-6">
                                <label for="input3" class="form-label">Deskripsi singkat Program Kerja</label>
                                <input type="text" name="description_prog" class="form-control border-3 border-success focus-ring focus-ring-success" id="input3">
                            </div>
                            ...
                            <table class="table table-bordered table-striped align-middle">
                                <thead class="border-3">
                                    <tr class="align-middle">
                                        ...
                                        <th class="border-3">Judul Program Kerja</th>
                                        <th class="border-3">Deskripsi Program Kerja</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border-3">{{ $proker->image_prog }}</td>
                                        <td class="border-3">{{ $proker->judul_prog }}</td>
                                        <td class="border-3">{{ $proker->description_prog }}</td>
                                        <td class="border-3">
                                            <a href="{{ url('edit-proker/'.$proker->id.'/delete') }}" class="btn btn-danger rounded-3 fw-semibold px-4 py-2">Hapus Data</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
