            ...
            <div class="dashboard-content px-3 pt-3">
                <div class="container p-3 rounded-4 mb-3" style="background-color: #eee">
                    ...
                    <div class="d-flex align-items-center">
                        <h4 class="fw-semibold me-3 pt-2">Edit Dokumentasi Dinas</h4>
                    ...
                    <div class="card-body">
                        <form class="row" action="{{ url('edit-doc/create') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="col-md-6">
                                <label for="input8" class="form-label">Upload Image Dokumentasi Kegiatan</label>
                                <input type="file" name="image_doc" class="form-control border-3 border-success focus-ring focus-ring-success" id="input8">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="input9" class="form-label">Nama Judul Dokumentasi Kegiatan</label>
                                <input type="text" name="judul_doc" class="form-control border-3 border-success focus-ring focus-ring-success" id="input9">
                            </div>
                            <div class="col-md-12">
                                <label for="input10" class="form-label">Deskripsi singkat Program</label>
                                <input type="text" name="description_doc" class="form-control border-3 border-success focus-ring focus-ring-success" id="input10">
                            </div>
                            ...
                            <table class="table table-bordered table-striped align-middle">
                                <thead class="border-3">
                                    <tr class="align-middle">
                                        ...
                                        <th class="border-3">Judul Dokumentasi Kegiatan</th>
                                        <th class="border-3">Deskripsi Dokumentasi Kegiatan</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border-3">{{ $doc->image_doc }}</td>
                                        <td class="border-3">{{ $doc->judul_doc }}</td>
                                        <td class="border-3">{{ $doc->description_doc }}</td>
                                        <td class="border-3">
                                            <a href="{{ url('edit-doc/'.$doc->id.'/delete') }}" class="btn btn-danger rounded-3 fw-semibold px-4 py-2">Hapus Data</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
